# Load settings from data bag 'elasticsearch/settings'B
#
...
default.elasticsearch[:bindir]    = "/opt/elasticsearch/elasticsearch/bin"
default.elasticsearch[:user]      = "elasticsearch"
default.elasticsearch[:uid]       = nil
default.elasticsearch[:gid]       = nil

default.elasticsearch[:path][:conf] = "/opt/elasticsearch/conf"
default.elasticsearch[:path][:data] = "/opt/elasticsearch/data"
default.elasticsearch[:path][:logs] = "/opt/elasticsearch/logs"

default.elasticsearch[:pid_path]  = "/opt/elasticsearch/run"
